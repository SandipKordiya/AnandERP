...
export class PurchaseReturnComponent implements OnInit {
  ...
  constructor(
    ...
    this.breadCrumbItems = [
      ...
      { label: 'New Purchase Return', active: true },
    ];
  }

  // form input values
  addPurchaseReturnForm = new FormGroup({
  ...
  get partyData() {
    return this.addPurchaseReturnForm.get('party');
  }

  get productDataFeild() {
    return this.addPurchaseReturnForm.get('productData');
  }
  ...
  getProductsByProductIdAndPartyId(id: number): void {
    this.shopService
      .getProductsByProductIdAndPartyId(id, this.partyData.value.id)
      .subscribe(
        (next) => {
  ...
  getSchemeByProductId() {
    ...
    let f = this.addPurchaseReturnForm.value;
  ...
  public onChangeBatchProduct() {
    let e = this.addPurchaseReturnForm.value.batchNumber;
  ...
  public ChangeTotalAmount() {
    ...
    // values from form
    let _quantity = this.addPurchaseReturnForm.value.quantity;
    let _rate = this.addPurchaseReturnForm.value.rate;
    let _discount = this.addPurchaseReturnForm.value.discount;
    let _otherDiscount = this.addPurchaseReturnForm.value.otherDiscount;
    let _taxid = this.addPurchaseReturnForm.value.Tax;
    let _mrp = this.addPurchaseReturnForm.value.mrp;
    // TaxPercentage
    // taxe rate
    try {
      let mrp = _mrp;
  ...
  private addNewProduct() {
    let formData = this.addPurchaseReturnForm.value;
    const item = {
  ...
  AddProduct() {
    ...
    let f = this.addPurchaseReturnForm.value;
    let productObject = {
      ...this.addPurchaseReturnForm.value,
      taxAmount: this.TaxAmount,
      taxPercentage: this.TaxPercentage,
      taxMargin: this.taxSaleMargin,
      discountAmount: this.DiscountAmount,
  ...
  submitPurchaseReturn(finalComponent) {
    ...
    if (this.orderId === undefined) {
      ...
      this.shopService.addPurchaseReturn(this.currentUser, SaleModel).subscribe(
        (next) => {
