...
namespace Shop.API.Migrations
{
    ...
    [Migration("20210518020357_companyBranchEntityUpdated")]
    partial class companyBranchEntityUpdated
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Shop.API.Dtos.ProductBranchRateSearchListDto", b =>
                {
                    ...
                    b.ToTable("ProductBranchRateSearchListDtos");
                });
            ...
            modelBuilder.Entity("Shop.API.Models.City", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop.API.Models.Country", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop.API.Models.State", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Shop.API.ViewModels.ItemWisePurchaseViewModel", b =>
                {
                    ...
                    b.ToTable("ItemWisePurchaseViewModels");
                });

            modelBuilder.Entity("Shop.API.ViewModels.ItemWiseSaleViewModel", b =>
                {
                    b.Property<decimal>("Amount")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("ItemWiseSaleViewModels");
                });
            ...
            modelBuilder.Entity("Shop.API.ViewModels.StockLedgerViewModel", b =>
                {
                    ...
                    b.Property<decimal?>("OpeningMRP")
                        .HasColumnType("decimal(18,2)");

                    b.Property<int>("OpeningQty")
                        .HasColumnType("int");

                    b.Property<decimal?>("OutwardMRP")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.ToTable("StockLedgerViewModels");
                });
            ...
            modelBuilder.Entity("Shop.API.ViewModels.StockWarehouseViewModel", b =>
                {
                    b.Property<string>("BatchNo")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("StockWarehouseViewModels");
                });
            ...
            modelBuilder.Entity("Shop.API.Models.City", b =>
                {
                    b.HasOne("Shop.API.Models.Country", "Country")
                        .WithMany()
                        .HasForeignKey("CountryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Shop.API.Models.State", "State")
                        .WithMany("Cities")
            ...
            modelBuilder.Entity("Shop.API.Models.Party", b =>
                {
                    ...
                    b.HasOne("Shop.API.Models.City", "City")
                        .WithMany()
